...
API_KEY = 'AIzaSyB-8-cTWN2Vr0owUBc5fkckkcShd1NLmvA'
...
TABLE_ID = '1dXuPXpezpqkDsff1RevqcNvSJhttrcSt7_4cDK2P'
...
def make_query(cols, values, limit):
    ...
    query = "SELECT " + string_cols + " FROM " + TABLE_ID + " WHERE Cause_Name = '" + string_values + "'"
